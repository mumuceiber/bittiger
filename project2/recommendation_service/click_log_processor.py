...
sould bias towards more recent results more.
'''
...
LOG_CLICKS_TASK_QUEUE_URL = "amqp://tibffleu:PRGvnjGl6hHY4G-Ewd5VckQnPFbtTIYk@termite.rmq.cloudamqp.com/tibffleu"
...
def handle_message(msg):
    ...
    # Update the click getOneNews
    old_p = model['preference'][click_class]
    model['preference'][click_class] = float((1 - ALPHA) * old_p + ALPHA)

    # Update not clicked CLASSES_NUMBER
